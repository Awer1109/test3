...
choices = ['台灣50 0050: 2022.1.1 至 2024.4.9', '大台指期貨2024.12到期: 2023.12 至 2024.4.11', '小台指期貨2024.12到期: 2023.12 至 2024.4.11', '英業達2020.1.2 至 2024.4.12', '堤維西2020.1.2 至 2024.4.12']
choice = st.selectbox('選擇金融商品', choices, index=0)
##### 读取Pickle文件
if choice == choices[0] :         ##'台積電: 2022.1.1 至 2024.4.9':
    df_original = load_data('kbars_1d_0050_2020-01-02_To_2025-03-04.pkl')
